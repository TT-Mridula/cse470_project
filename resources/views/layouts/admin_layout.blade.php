...
<html lang="en">
    ...
    <body>
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Skill Stacker</a>
            <!-- Sidebar Toggle-->
...
<div class="collapse" id="collapseLayouts" data-bs-parent="#sidenavAccordion" aria-labelledby="headingServices">
  <nav class="sb-sidenav-menu-nested nav">
    <a class="nav-link" href="{{ route('admin.services.create') }}">Create</a>
    <a class="nav-link" href="{{ route('admin.services.list') }}">List</a>
  </nav>
...
<div class="collapse" id="collapseLayouts2" data-bs-parent="#sidenavAccordion" aria-labelledby="headingPortfolio">
  <nav class="sb-sidenav-menu-nested nav">
    <a class="nav-link" href="{{ route('admin.portfolios.create') }}">Create</a>
    <a class="nav-link" href="{{ route('admin.portfolios.list') }}">List</a>
  </nav>
